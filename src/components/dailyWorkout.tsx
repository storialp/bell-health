 ...
 return (
  <>
   ...
   <div className="flex flex-col gap-y-1">
    ...
    <img src="https://utfs.io/f/7e75013f-2d29-473c-aa44-0d6801b0cd51-wjdkh3.png" alt="Carlotta picture" className='h-48 w-auto z-30 absolute ml-36 mt-56' />
   ...
   <div className="bg-amber-400 text-center font-bold rounded-lg w-3/4 ml-8 py-2 mt-48 absolute z-30">I&apos;M DONE!</div>
  </>
 )
}